...
public class Test02A extends JPanel implements ActionListener {
	...
	public Test02A() {
		...
		patternLabel.setBounds(10, 10, patternLabel.getPreferredSize().width, patternLabel.getPreferredSize().height);
		...
		resultLabel.setBounds(10, 70, 400, resultLabel.getPreferredSize().height);
