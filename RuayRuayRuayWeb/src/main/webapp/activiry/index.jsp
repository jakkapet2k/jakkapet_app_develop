	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="activiry/OrderReport.jsp">OrderReport</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="activiry/SalesReport.jsp">SalesReport</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="activiry/BalanceReport.jsp">BalanceReport</a>
            </li>
            <li class="nav-item">
		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td><%=g.getPrice()%></td>
					<td><%=g.getStocks()%></td>
					<td><a href="../purchase.jsp?id=<%= g.getid() %>"><button class="btn btn-outline-dark">Purchase</button></a></td>
				</tr>
				<%
				}
				%>
