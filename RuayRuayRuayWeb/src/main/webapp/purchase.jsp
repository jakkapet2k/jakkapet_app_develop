    ...
    <div>
     <form action="thankyou.jsp" method="post">
        <div class=" mb-3 row">
          ...
          <div class="col-sm-2">
            <input type="test"  class="form-control-plaintext" id="nameGood" name="idGood" value=" <%=request.getParameter("id")%>"  >
          </div>
          </div>
        ...
        <div class=" mb-3 row">
          ...
          <div class="col-sm-2">
            <input type="test"  class="form-control-plaintext" id="nameGood" name="nameGood" value="<%=request.getParameter("Name")%>">
          </div>
          </div>
          ...
          <div class="col-sm-2">
            <input type="test"  class="form-control-plaintext" id="nameGood" name="priceGood" value="<%=request.getParameter("Unit_Price")%> " >
          </div>
          </div>
        ...
        <div class=" mb-3 row">
          ...
          <div class="col-sm-2">
            <input type="numbers" class="form-control" id="qty" name="qty" required>
            <td><a href="thankyou.jsp"><button class=" mt-5  btn btn-outline-dark">Check Out</button></a></td>
          </div>  
    	</div>
</form>
