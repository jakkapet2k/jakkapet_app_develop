...
public class CustomerDelete extends JPanel implements ActionListener {
	...
	public CustomerDelete(Main main) {
		...
		JLabel lblDeleteSupplier = new JLabel("Delete Customer");
		...
		lbCustomer.setBounds(173, 33, 118, 21);
		add(lbCustomer);
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (command.equals(DeleteString)) {
			...
			try {
				int id = 0;
				int idcust = Integer.parseInt(idField.getText());;

				Customer Delete = new Customer(idcust, null,null);
